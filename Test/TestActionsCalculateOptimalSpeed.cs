...
namespace Test
{
    ...
    public class TestCalculateOptimalSpeed
    {
        ...
        public void Turn_180()
        {
            ...
            Assert.AreEqual(Actions.CalculateOptimalSpeed(angle), -1);
        }
        ...
        public void Turn_90()
        {
            ...
            Assert.AreEqual(Actions.CalculateOptimalSpeed(angle), 0.5);
        }
        ...
        public void Turn_M45()
        {
            ...
            Assert.AreEqual(Actions.CalculateOptimalSpeed(angle), 0.75);
        }
